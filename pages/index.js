...
export default function Home() {
  ...
  return (
    <>
      <Head>
        <title>
          {title === '' ? 'Cari Kode Pos di Indonesia' : `${title}`}
        </title>
        <meta
          name="description"
          content="Cari kode pos Indonesia menggunakan nama kota, kabupaten, atau kecamatan."
        />
        <meta
          name="og:title"
          property="og:title"
          content={title === '' ? 'Cari Kode Pos di Indonesia' : `${title}`}
        />
        <meta
          name="og:description"
          ...
          content="Cari kode pos Indonesia menggunakan nama kota, kabupaten, atau kecamatan."
        />
        <meta property="og:site_name" content="kodepos-web" />
        <meta property="og:url" content="https://kodepos-web.vercel.app" />
      </Head>
